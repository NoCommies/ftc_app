...
public abstract class RR_Robot extends OpMode {
    ...
    static void turnWithEncoders(double power, double leftEncoderTarget, double rightEncoderTarget) {

        setMotorsTargets(leftEncoderTarget, new DcMotor[]{frontLeftMotor, backLeftMotor});
        setMotorsTargets(rightEncoderTarget, new DcMotor[]{backRightMotor, frontRightMotor});
